...
<div className="table-responsive">
  <table className="table table-striped">
    ...
    <tr>
      ...
      <td>yes</td>
      <td>
        yes, only when created by the{" "}
        <Link to="/web-clipper">TagSpaces Web Clipper</Link> extension
      </td>
      <td>yes</td>
      <td>
...
<div className="table-responsive">
  <table className="table table-striped">
    ...
    <tr>
      ...
      <td>yes</td>
      <td>
        <Link to="/extensions/contact-viewer/">Contact Editor</Link>
      </td>
    </tr>
  </table>
</div>
...
<div className="table-responsive">
  <table className="table table-striped">
    ...
    <tr>
      <td>ZIP</td>
      <td>yes</td>
      <td>yes, the largest image in the archive is used as screenshot</td>
      <td>no</td>
      <td>

...
description: Complete reference of file formats supported in TagSpaces for viewing, editing, and thumbnail generation including images, documents, audio, video, and 3D files.
---
...
<div className="table-responsive">
  <table className="table table-striped">
    ...
    <tr>
      <td>STL <ProFeature /></td>
      <td>yes</td>
      <td>yes, after opening the file</td>
      <td>no</td>
      <td>
...
<div className="table-responsive">
  <table className="table table-striped">
    ...
    <tr>
      <td>URL</td>
      <td>yes</td>
      <td title="Only when created by the TagSpaces Web Clipper extension">yes</td>
      <td>no</td>
      <td>
...
<div className="table-responsive">
  <table className="table table-striped">
    ...
    <tr>
      ...
      <td>no</td>
      <td>
        <Link to="/extensions/contact-viewer">MSG Viewer</Link>
      </td>
    </tr>
  </table>
</div>
...
<div className="table-responsive">
  <table className="table table-striped">
    ...
    <tr>
      <td>ZIP</td>
      <td>yes</td>
      <td title="The largest image in the archive is used as screenshot">yes</td>
      <td>no</td>
      <td>
...
<div className="table-responsive">
  <table className="table table-striped">
    ...
    <tr>
      <td>TTF <ProFeature /></td>
      <td>yes</td>
      <td>yes, after opening the file</td>
      <td>no</td>
      <td>
        <Link to="/extensions/font-viewer">Font Viewer</Link>
      </td>
    </tr>
    <tr>
      <td>WOFF <ProFeature /></td>
      <td>yes</td>
      <td>yes, after opening the file</td>
      <td>no</td>
      <td>

...
<div className="table-responsive">
  <table className="table table-striped">
    ...
    <tr>
      <td>URL</td>
      <td>yes</td>
      <td title="Only when created by the TagSpaces Web Clipper extension">yes <ProFeature /></td>
      <td>no</td>
      <td>
...
<div className="table-responsive">
  <table className="table table-striped">
    ...
    <tr>
      <td>ZIP</td>
      <td>yes</td>
      <td title="The largest image in the archive is used as screenshot">yes <ProFeature /></td>
      <td>no</td>
      <td>

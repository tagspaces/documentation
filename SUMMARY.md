...
* [About](README.md)
    ...
    * [This Document](README.md#about-this-document)
...
* [Browsing Files in Perspectives](browsing-files.md)
    ...
    * [Default Perspective ⚒](browsing-files.md#default-perspective)
...
* [Creating & editing Files](editing-files.md)
    ...
    * [Editing Text files](editing-files.md#text-editor)
    * [Editing MarkDown files](editing-files.md#markdown-editor)
    * [Editing JSON files](editing-files.md#json-editor)
